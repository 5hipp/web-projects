...
$l['avatarep_descrip'] = "Shows avatars into all posible zones of forums where it does not present.";
$l['avatarep_config'] = "Plugin Configuration";
$l['avatarep_style_usernames'] = "You have Style Usernames Plugin (Disable Formatted names option in avatar options, or Uninstall Style Usernames from your forums to not get errors.)";
...
$l['avatarep_usercp_fsubs_desc'] = "Disable if you want not to show avatar into usercp forum subscriptions template";

$l['avatarep_similar_threads'] = "Show avatars for similar threads templates into showthread";
$l['avatarep_similar_threads_desc'] = "Disable if you want not to show avatar into showthread similar threads template";
